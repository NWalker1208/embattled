...
extern void test_lsh_should_setAcToRegisterALeftShiftedByRegisterBSigned_when_registerBIsPositive(void);
extern void test_lsh_should_setAcToRegisterALeftShiftedByRegisterBSigned_when_registerBIsNegative(void);
...
int main(void)
{
  ...
  run_test(test_lsh_should_setAcToRegisterALeftShiftedByRegisterBSigned_when_registerBIsPositive, "test_lsh_should_setAcToRegisterALeftShiftedByRegisterBSigned_when_registerBIsPositive", 1257);
  run_test(test_lsh_should_setAcToRegisterALeftShiftedByRegisterBSigned_when_registerBIsNegative, "test_lsh_should_setAcToRegisterALeftShiftedByRegisterBSigned_when_registerBIsNegative", 1278);
